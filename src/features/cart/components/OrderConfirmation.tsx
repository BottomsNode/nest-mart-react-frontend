        ...
        <div className="max-w-2xl mx-auto py-12 px-4">
            ...
            {pdfUrl && (
                <div className="mt-8 bg-green-50 rounded-lg p-6">
                    {(() => {
                        const viewablePdfUrl = `https://docs.google.com/viewer?url=${encodeURIComponent(pdfUrl)}&embedded=true`;
                        return (
                            <>
                                ...
                                <div className="flex flex-col items-center space-y-4">
                                    ...
                                    <div className="bg-white p-4 rounded-lg border">
                                        ...
                                        <img src={generateQRCode(viewablePdfUrl)} alt="QR Code for Invoice" className="mx-auto" />
                                    </div>
                                </div>
                            </>
                        );
